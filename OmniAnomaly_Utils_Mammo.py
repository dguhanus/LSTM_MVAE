...
def get_data_dim(dataset):
    if str(dataset).startswith('machine'):
        df = pd.read_csv('./ServerMachineDataset/train/machine-1-1.txt')
    elif str(dataset).startswith('pima'):
        df = pd.read_csv('./PimaDataset/train/pima-1-1.txt')
    elif str(dataset).startswith('nab'):
        df = pd.read_csv('./NABDataset/train/nab-1-1.txt')
    elif str(dataset).startswith('Yahoo'):
        df = pd.read_csv('./YahooDataset/train/Yahoo-1-1.txt')
    elif str(dataset).startswith('Gas'):
        df = pd.read_csv('./GasDataset/train/Gas-1-1.txt')
    elif str(dataset).startswith('pendigit'):
        df = pd.read_csv('./PenDigitDataset/train/pendigit-1-1.txt')
    elif str(dataset).startswith('NSLKDD'):
        df = pd.read_csv('./NSLKDD_Dataset/train/NSLKDD_2-1-1.txt')
    elif str(dataset).startswith('UNSW'):
        df = pd.read_csv('./UNSW_Dataset/train/UNSW_2-1-1.txt')
    elif str(dataset).startswith('Shuttle'):
        df = pd.read_csv('./ShuttleDataset/train/Shuttle-1-1.txt')
    elif str(dataset).startswith('Mamo'):
        df = pd.read_csv('./Mamography_Dataset/train/Mamo-1-1.txt')
    else:
